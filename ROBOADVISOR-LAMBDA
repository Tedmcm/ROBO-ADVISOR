    ...
    if age is not None:
        ...
        if age >= 65:
            return build_validation_result(
                False,
                'age',
                'I see you might be over 65 which is over our limit'
                '...Please try again',
            )
        if age < 0:
            return build_validation_result(
                False,
                'age',
                'You must have been born to be speaking with me.. '
                '  Please tell me how many years you have been alive.',
                )
    ...
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                False,
                "investmentAmount",
                "Sorry, The minimum amount to start is 5,000 dollars, "
                "please increase the amount and lets put your money to work!.",
            )
